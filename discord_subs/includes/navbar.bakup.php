...
* NOTA: Este bloque fue la causa de un error anterior. Lo he desactivado temporalmente
* comentándolo. Si deseas reactivar el contador de notificaciones, primero debemos
* depurar por qué falla en tu servidor, pero por ahora, lo dejamos así para
...
<nav class="navbar border-b border-gray-800 sticky top-0 z-50 bg-gray-900 text-white">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <a href="<?= SITE_URL ?>index.php" class="navbar-brand">
            <img src="/assets/images/logo.png" alt="Logo KekaGamer" style="height: 2rem; width: auto; display: block;">
        </a>
...
<style>
    // Estilos para los links (sin cambios)
</style>